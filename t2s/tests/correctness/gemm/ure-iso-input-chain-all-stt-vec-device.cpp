...
int main(void) {
    ...
    // Note: Please do not remove Func fk, fkk, lk, and directly isolate their
    // expressions out, which is correct, but already covered in other tests.
    // Let us keep this test as another way to write isolation.
    Func fk, fkk, lk;
    fk(P)      = k;
    fkk(P)     = kk;
    lk(P)      = K - 1 - k;      
    ...
    firstk.isolate_producer_chain({a, fk, fkk, lk}, feederA);
