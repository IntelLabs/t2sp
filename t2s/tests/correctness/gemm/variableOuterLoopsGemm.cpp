...
Func SGEMM() {
    ...
    #define P_iii_minus_1 kkk,           jjj,     iii - 1, kk,          jj, ii, k,     j, i // To be used only when iii != 0
    #define P_jjj_minus_1 kkk,           jjj - 1, iii,     kk,          jj, ii, k,     j, i // T0 be used only when jjj != 0
    #define P_kkk_minus_1 kkk - 1,       jjj,     iii,     kk,          jj, ii, k,     j, i // To be used only when kkk != 0
    #define P_kk_minus_1  kkk + KKK - 1, jjj,     iii,     kk - 1,      jj, ii, k,     j, i // To be used only when kkk == 0
    #define P_k_minus_1   kkk + KKK - 1, jjj,     iii,     kk + KK - 1, jj, ii, k - 1, j, i // To be used only when kkk == 0 and kk == 0
