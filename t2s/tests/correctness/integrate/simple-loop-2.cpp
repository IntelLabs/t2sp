...
// g++ simple-loop-2.cpp -g -I ../util  -I ../../../../Halide/include -L ../../../../Halide/bin -lHalide -lpthread -ldl -std=c++11 -DSIZE=10  -DVERBOSE_DEBUG -DPLACE0=Place::Host -DPLACE1=Place::Host
...
int main(void) {
  ...
  A2.space_time_transform(i2);

  Buffer<int> result = consumer.realize({SIZE, SIZE}, target);
