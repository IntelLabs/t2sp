...
int main(void) {
    ...
    Func Alpha("Alpha", PLACE), Beta("Beta", PLACE), Out("Out", PLACE);
    ...
    Out(rrr, hhh, rr, hh) = select(i_is_last && j_is_last, Sum(A));
