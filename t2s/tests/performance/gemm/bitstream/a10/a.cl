...
typedef struct { float16 s[10]; } _aFeeder_channel_array_t;
 ...
 const int _B_extent_0)
{
 ...
 int _20 = _A_extent_1 / 320;
 int _21 = _B_extent_0 >> 8;
 int _22 = _20 * _21;
 int _23 = _19 * _22;
 int _24 = _23 * 32768;
 int _25 = _24 + 32768;
 for (int _aFeeder_s0_outermost_loop = 0; _aFeeder_s0_outermost_loop < 0 + _25; _aFeeder_s0_outermost_loop++)
 {
  ...
  int _35 = _A_extent_1 / 320;
  int _36 = _B_extent_0 >> 8;
  int _37 = _35 * _36;
  int _38 = _34 * _37;
  bool _39 = _33 < _38;
  bool _40 = _30 && _39;
  ...
  for (int _aFeeder_s0_buf = 0; _aFeeder_s0_buf < 0 + 10; _aFeeder_s0_buf++)
  {
   ...
   int _96 = _A_extent_1 / 320;
   int _97 = _B_extent_0 >> 8;
   int _98 = _96 * _97;
   int _99 = _95 * _98;
   bool _100 = _94 <= _99;
  ...
  int _128 = _A_extent_1 / 320;
  int _129 = _B_extent_0 >> 8;
  int _130 = _128 * _129;
  int _131 = _127 * _130;
  bool _132 = _126 <= _131;
 ...
 const int _B_extent_0)
{
 ...
 int _155 = _A_extent_1 / 320;
 int _156 = _B_extent_0 >> 8;
 int _157 = _155 * _156;
 int _158 = _154 * _157;
 int _159 = _158 * 32768;
 int _160 = _159 + 32768;
 for (int _bFeeder_s0_outermost_loop = 0; _bFeeder_s0_outermost_loop < 0 + _160; _bFeeder_s0_outermost_loop++)
 {
  ...
  int _170 = _A_extent_1 / 320;
  int _171 = _B_extent_0 >> 8;
  int _172 = _170 * _171;
  int _173 = _169 * _172;
  bool _174 = _168 < _173;
  bool _175 = _165 && _174;
  ...
  for (int _bFeeder_s0_buf = 0; _bFeeder_s0_buf < 0 + 8; _bFeeder_s0_buf++)
  {
   ...
   int _231 = _A_extent_1 / 320;
   int _232 = _B_extent_0 >> 8;
   int _233 = _231 * _232;
   int _234 = _230 * _233;
   bool _235 = _229 <= _234;
  ...
  int _262 = _A_extent_1 / 320;
  int _263 = _B_extent_0 >> 8;
  int _264 = _262 * _263;
  int _265 = _261 * _264;
  bool _266 = _260 <= _265;
 ...
 const int _B_extent_0)
{
 ...
 int _275 = _A_extent_1 / 320;
 int _276 = _B_extent_0 >> 8;
 int _277 = _275 * _276;
 int _278 = _274 * _277;
 int _279 = _278 + 1;
 for (int _X_s0_i_j_k = 0; _X_s0_i_j_k < 0 + _279; _X_s0_i_j_k++)
 {
  for (int _X_s0_kk_ii_jj = 0; _X_s0_kk_ii_jj < 0 + 32768; _X_s0_kk_ii_jj++)
  {
   ...
   int _288 = _A_extent_1 / 320;
   int _289 = _B_extent_0 >> 8;
   int _290 = _288 * _289;
   int _291 = _287 * _290;
 ...
 __address_space__unloader_mem_channel float *restrict _unloader_mem_channel)
{
 ...
 for (int _unloader_s0_i = 0; _unloader_s0_i < 0 + _386; _unloader_s0_i++)
 {
  ...
  for (int _unloader_s0_j = 0; _unloader_s0_j < 0 + _387; _unloader_s0_j++)
  {
   ...
   {
    float8 __388 = read_channel_intel(_Out_channel);
    int _389 = _addr_temp;
    int _390 = _389 * 8;
    vstore8(__388, 0, (__address_space__unloader_mem_channel float*)_unloader_mem_channel + _390);
    int _391 = _addr_temp;
    int _392 = _391 + 1;
    _addr_temp = _392;
