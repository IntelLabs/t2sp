...
echo "CMD: g++ capsule.gpu.spec.cpp -I ${T2S_PATH}/t2s/src/ -I ${T2S_PATH}/t2s/tests/correctness/util -I ${T2S_PATH}/Halide/include -L ${T2S_PATH}/Halide/bin -lz -lpthread -ldl -std=c++11 -lHalide -DTINY -DGPU;";
g++ capsule.gpu.spec.cpp \
    -I ${T2S_PATH}/t2s/src/ \
...
echo "clang++ -fsycl -I $T2S_PATH/install/llvm-test-suite/SYCL/ESIMD/ capsule.gpu.run.cpp"
clang++ -fsycl -I $T2S_PATH/install/llvm-test-suite/SYCL/ESIMD/ capsule.gpu.run.cpp;
#execution
